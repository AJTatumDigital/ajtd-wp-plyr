...
function ajtd_plyr_init()
{
    ...
    {
        wp_register_style('plyr', AJTD_PLYR_PLUGIN_URL . 'public/plyr-3.7.8/plyr.min.css', array(), '3.7.8', 'all');
        wp_register_style('ajtd-plyr', AJTD_PLYR_PLUGIN_URL . 'public/css/ajtd-plyr.min.css', array('plyr'), '1.0.0', 'all');
        wp_register_script('plyr', AJTD_PLYR_PLUGIN_URL . 'public/plyr-3.7.8/plyr.min.js', array('jquery'), '3.7.8', true);
        wp_register_script('hls', AJTD_PLYR_PLUGIN_URL . 'public/hls-1.4.5/hls.min.js', array('jquery'), '1.4.5', true);
        wp_register_script('ajtd-plyr-hls', AJTD_PLYR_PLUGIN_URL . 'public/js/ajtd-plyr-hls.min.js', array('jquery', 'plyr', 'hls'), '1.0.8', true);
        wp_register_script('mux-embed', AJTD_PLYR_PLUGIN_URL . 'public/js/mux-embed.min.js', array('jquery', 'plyr', 'hls', 'ajtd-plyr-hls'), '4.25.1', true);
    }
    ...
    function ajtd_plyr_scripts_styles()
    {
        ...
        wp_print_styles(array('plyr', 'ajtd-plyr'));
        wp_print_scripts(array('plyr', 'hls', 'ajtd-plyr-hls', 'mux-embed'));
    }
